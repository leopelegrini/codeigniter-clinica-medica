                    ...
                    <div class="form-row">
                        <div class="col-lg-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="crm" class="form-control" id="crm" value="<?= set_value('crm') ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="especialidade_id" class="form-control" id="especialidade_id" value="<?= set_value('especialidade_id') ?>">
